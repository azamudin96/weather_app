...
class Data {
  ...
  String getTemp() {
    var celcius = main!.temp! - 273.15;
    return '${celcius.toStringAsFixed(2)} °C';
  }

  String getTempMin() {
    var celcius = main!.tempMin! - 273.15;
    return '${celcius.toStringAsFixed(2)} °C';
  }

  String getTempMax() {
    var celcius = main!.tempMax! - 273.15;
    return '${celcius.toStringAsFixed(2)} °C';
  }
  ...
  String getDtFormatted() {
    var date = DateTime.parse(dtTxt!);
    return DateFormat('dd/MM/yyyy').format(date);
  }

  String getDtFormattedWithSuffix() {
    var date = DateTime.parse(dtTxt!);
    var suffix = "th";
    ...
    return new DateFormat("d'$suffix' MMM yyyy").format(date);
  }
